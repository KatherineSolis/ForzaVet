    ...
    <el-row>
      <el-card class="box-card">
        ...
        >
          ...
          <el-table-column label="Acciones" align="center" width="300" class-name="small-padding fixed-width">
            <template slot-scope="{row}">
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" style="min-width:50vh;">
          ...
          <el-form ref="dataForm" :rules="rules" :model="temp" style="padding:0px 30px;">
            <el-form-item label="Tipo:" prop="document_type">
              <el-select id="document_type" v-model="temp.document_type" placeholder="Seleccionar" style="width:100%">
                <el-option
...
export default {
  ...
  data() {
    var validateDocumentType = (rule, value, callback) => {
      const select = document.getElementById('document_type').value;
      if (select === 'Cedula'){
        const valCedula = this.verificarCedula(value);
        ...
        const valRuc = this.verificacionRuc(value);
  ...
  methods: {
    ...
    verificacionRuc(numero){
      ...
      const provincia = numero.substr(0, 2);
      ...
      if (d3 < 6){
        nat = true;
        var p1 = d1 * 2; if (p1 >= 10) {
          p1 -= 9;
        }
        var p2 = d2 * 1; if (p2 >= 10) {
          p2 -= 9;
        }
        var p3 = d3 * 2; if (p3 >= 10) {
          p3 -= 9;
        }
        var p4 = d4 * 1; if (p4 >= 10) {
          p4 -= 9;
        }
        var p5 = d5 * 2; if (p5 >= 10) {
          p5 -= 9;
        }
        var p6 = d6 * 1; if (p6 >= 10) {
          p6 -= 9;
        }
        var p7 = d7 * 2; if (p7 >= 10) {
          p7 -= 9;
        }
        var p8 = d8 * 1; if (p8 >= 10) {
          p8 -= 9;
        }
        var p9 = d9 * 2; if (p9 >= 10) {
          p9 -= 9;
        }
        modulo = 10;
      }
