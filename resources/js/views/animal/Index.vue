    ...
    <el-row>
      <el-card class="box-card" style="height: 90vh">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.observation }}</span>
            </template>
          </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
          <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="width: 500px; margin-left:50px;">
            ...
            <el-form-item label="Observación" prop="observation">
              <el-input v-model="temp.observation" />
            </el-form-item>
          </el-form>
...
<script>
import { fetchList, createAnimal, updateAnimal } from '@/api/animal';
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          this.temp.status = 1;
          createAnimal(this.temp).then((response) => {
