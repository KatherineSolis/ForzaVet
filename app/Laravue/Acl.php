...
final class Acl
{
    ...
    const PERMISSION_VIEW_MENU_VACCINE = 'view menu vaccine';
    const PERMISSION_VIEW_MENU_ANTIPARASITIC = 'view menu antiparasitic';
    const PERMISSION_VIEW_MENU_PERSONAL = 'view menu personal';
    const PERMISSION_VIEW_MENU_CLIENT = 'view menu client';
    const PERMISSION_VIEW_MENU_PET = 'view menu pet';
    const PERMISSION_VIEW_MENU_APPOINTMENT= 'view menu appointment';
